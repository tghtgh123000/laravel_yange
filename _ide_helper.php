 ...
 * Generated for Laravel 5.4.9 on 2019-05-04 13:56:42.
 *
...
namespace Illuminate\Support\Facades { 
     ...
     * @method static setex($key,$second,$value)
     * @method static zlexcount($key,$val1,$val2)
     * @method static zcount($key,$min,$max)
     * @method static zadd($key,$score,$value)
     * @method static expire($key,$seconds)
     * @method static setnx($key,$val)
     */
    class Redis {
